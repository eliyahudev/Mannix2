...
//*# Library Name   : ts6n16ffcllulvtb128x32m4 (user specify : ts6n16ffcllulvtb128x32m4)				*/
//*# Library Version: 120a												*/
//*# Generated Time : 2020/08/20, 16:41:46										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS6N16FFCLLULVTB128X32M4 (
  AA,
  D,
  WEB,
  AB,
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "TS6N16FFCLLULVTB128X32M4_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "TS6N16FFCLLULVTB128X32M4_fault.cde";
`endif
...
TS6N16FFCLLULVTB128X32M4_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
*/
module TS6N16FFCLLULVTB128X32M4_Int_Array (D, BW, AW, EN, RDB, AR, Q);
