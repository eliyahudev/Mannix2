...
//*# Library Name   : ts6n16ffcllulvtb64x32m1 (user specify : ts6n16ffcllulvtb64x32m1)				*/
//*# Library Version: 120a												*/
//*# Generated Time : 2020/09/02, 14:27:53										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS6N16FFCLLULVTB64X32M1 (
  AA,
  D,
  WEB,
  AB,
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "TS6N16FFCLLULVTB64X32M1_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "TS6N16FFCLLULVTB64X32M1_fault.cde";
`endif
...
TS6N16FFCLLULVTB64X32M1_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
*/
module TS6N16FFCLLULVTB64X32M1_Int_Array (D, BW, AW, EN, RDB, AR, Q);
