...
//
//       Instance Name:              ARM_SPSRAM_128X2048_M4_MEM
//       Words:                      2048
//       Bits:                       128
//       Mux:                        4
//       Drive:                      6
...
//       
//       Creation Date:  Mon Feb 17 00:46:48 2020
//       Version: 	r1p0
//
...
`ifdef POWER_PINS
module ARM_SPSRAM_128X2048_M4_MEM (VDD, VDDP, VSS, Q, CLK, CEN, WEN, A, D, EMA, EMAW,
    EMAS, GWEN, RET1N);
`else
module ARM_SPSRAM_128X2048_M4_MEM (Q, CLK, CEN, WEN, A, D, EMA, EMAW, EMAS, GWEN, RET1N);
`endif
  ...
  begin
    if (RET1N_int === 1'bx || RET1N_int === 1'bz) begin
      ...
      if (GWEN_int !== 1'b1) begin
        ...
        new_data =  ( {3'b000, D_int[127], 3'b000, D_int[126], 3'b000, D_int[125],
          3'b000, D_int[124], 3'b000, D_int[123], 3'b000, D_int[122], 3'b000, D_int[121],
          3'b000, D_int[120], 3'b000, D_int[119], 3'b000, D_int[118], 3'b000, D_int[117],
          3'b000, D_int[116], 3'b000, D_int[115], 3'b000, D_int[114], 3'b000, D_int[113],
          3'b000, D_int[112], 3'b000, D_int[111], 3'b000, D_int[110], 3'b000, D_int[109],
          3'b000, D_int[108], 3'b000, D_int[107], 3'b000, D_int[106], 3'b000, D_int[105],
          3'b000, D_int[104], 3'b000, D_int[103], 3'b000, D_int[102], 3'b000, D_int[101],
...
`endif
  ...
  reg NOT_WEN1, NOT_WEN0, NOT_A10, NOT_A9, NOT_A8, NOT_A7, NOT_A6, NOT_A5, NOT_A4;
  reg NOT_A3, NOT_A2, NOT_A1, NOT_A0, NOT_D127, NOT_D126, NOT_D125, NOT_D124, NOT_D123;
  reg NOT_D122, NOT_D121, NOT_D120, NOT_D119, NOT_D118, NOT_D117, NOT_D116, NOT_D115;
  reg NOT_D114, NOT_D113, NOT_D112, NOT_D111, NOT_D110, NOT_D109, NOT_D108, NOT_D107;
  reg NOT_D106, NOT_D105, NOT_D104, NOT_D103, NOT_D102, NOT_D101, NOT_D100, NOT_D99;
  reg NOT_D98, NOT_D97, NOT_D96, NOT_D95, NOT_D94, NOT_D93, NOT_D92, NOT_D91, NOT_D90;
  reg NOT_D89, NOT_D88, NOT_D87, NOT_D86, NOT_D85, NOT_D84, NOT_D83, NOT_D82, NOT_D81;
  reg NOT_D80, NOT_D79, NOT_D78, NOT_D77, NOT_D76, NOT_D75, NOT_D74, NOT_D73, NOT_D72;
  reg NOT_D71, NOT_D70, NOT_D69, NOT_D68, NOT_D67, NOT_D66, NOT_D65, NOT_D64, NOT_D63;
  reg NOT_D62, NOT_D61, NOT_D60, NOT_D59, NOT_D58, NOT_D57, NOT_D56, NOT_D55, NOT_D54;
  reg NOT_D53, NOT_D52, NOT_D51, NOT_D50, NOT_D49, NOT_D48, NOT_D47, NOT_D46, NOT_D45;
  ...
  reg NOT_EMA1, NOT_EMA0, NOT_EMAW1, NOT_EMAW0, NOT_EMAS, NOT_GWEN, NOT_RET1N;
 ...
 wire  CLK_;
  ...
  buf B367(D_[98], D[98]);
  buf B368(D_[99], D[99]);
  buf B369(D_[100], D[100]);
  buf B370(D_[101], D[101]);
  buf B371(D_[102], D[102]);
  buf B372(D_[103], D[103]);
  buf B373(D_[104], D[104]);
  buf B374(D_[105], D[105]);
  buf B375(D_[106], D[106]);
  buf B376(D_[107], D[107]);
  buf B377(D_[108], D[108]);
  buf B378(D_[109], D[109]);
  buf B379(D_[110], D[110]);
  buf B380(D_[111], D[111]);
  buf B381(D_[112], D[112]);
  buf B382(D_[113], D[113]);
  buf B383(D_[114], D[114]);
  buf B384(D_[115], D[115]);
  buf B385(D_[116], D[116]);
  buf B386(D_[117], D[117]);
  buf B387(D_[118], D[118]);
  buf B388(D_[119], D[119]);
  buf B389(D_[120], D[120]);
  buf B390(D_[121], D[121]);
  buf B391(D_[122], D[122]);
  buf B392(D_[123], D[123]);
  buf B393(D_[124], D[124]);
  buf B394(D_[125], D[125]);
  buf B395(D_[126], D[126]);
  buf B396(D_[127], D[127]);
  buf B397(EMA_[0], EMA[0]);
  buf B398(EMA_[1], EMA[1]);
  buf B399(EMA_[2], EMA[2]);
  buf B400(EMAW_[0], EMAW[0]);
  buf B401(EMAW_[1], EMAW[1]);
  buf B402(EMAS_, EMAS);
  buf B403(GWEN_, GWEN);
  buf B404(RET1N_, RET1N);

   `ifdef ARM_FAULT_MODELING
     ARM_SPSRAM_128X2048_M4_MEM_error_injection u1(.CLK(CLK_), .Q_out(Q_), .A(A_int), .CEN(CEN_int), .GWEN(GWEN_int), .WEN(WEN_int), .Q_in(Q_int));
  `else
...
`endif
`timescale 1ns/1ps
module ARM_SPSRAM_128X2048_M4_MEM_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, GWEN);
   output [127:0] Q_out;
   input [127:0] Q_in;
   input CLK;
   input [10:0] A;
