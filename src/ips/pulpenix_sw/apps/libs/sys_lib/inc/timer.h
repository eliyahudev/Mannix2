...
#define TIMERA_LO_ADDR         0x00
#define TIMERA_HI_ADDR         0x04

#define TIMERA_OUPUT_CMP       0x08
#define TIMERA_OUPUT_CMP_LO    0x08
#define TIMERA_OUPUT_CMP_HI    0x0c

#define TIMERA_CTRL            0x10

#define TIMERB_ADDR            0x20
#define TIMERB_LO_ADDR         0x20
#define TIMERB_HI_ADDR         0x24

#define TIMERB_OUPUT_CMP       0x28
#define TIMERB_OUPUT_CMP_LO    0x28
#define TIMERB_OUPUT_CMP_HI    0x2c

#define TIMERB_CTRL            0x30

/* pointer to mem of timer unit - PointerTimer */
#define __PT__(a) *(volatile uint32_t*) (TIMER_BASE_ADDR + a)

/** timer A register - contains the actual cycle counter */
#define TIRA  __PT__(TIMERA_ADDR)
#define TIRAL __PT__(TIMERA_LO_ADDR)
#define TIRAH __PT__(TIMERA_HI_ADDR)
...
#define TOCRAL __PT__(TIMERA_OUPUT_CMP_LO)
#define TOCRAH __PT__(TIMERA_OUPUT_CMP_HI)

/** timer B register - contains the actual cycle counter */
#define TIRB  __PT__(TIMERB_ADDR)
#define TIRBL __PT__(TIMERB_LO_ADDR)
#define TIRBH __PT__(TIMERB_HI_ADDR)
...
#define TOCRBL __PT__(TIMERB_OUPUT_CMP_LO)
#define TOCRBH __PT__(TIMERB_OUPUT_CMP_HI)
