...
//  TIME STAMPIMG (Added by Udi 15/Jun/20)
void enable_cycle_count() ; // Enable Cycle counter CSR 
void reset_cycle_count() ;  // Enable Cycle counter CSR 
int get_cycle_count() ;     // Return current cycle count
